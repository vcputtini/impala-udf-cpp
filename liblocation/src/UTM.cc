...
// Port to C++ by Alex Hajnal <https://alephnull.net/software/gis/UTM_WGS84_C_plus_plus.shtml>
//
...
//
// ****************************************************************************
// ChangeLog: Author: Volnei Cervi Puttini <vcputtini@gmail.com> April'20
//
...
// + Tested C++ compilers: -std=c++0x and c++11.
//
// ****************************************************************************
#include "UTM.h"
...
FLOAT UTM::ArcLengthOfMeridian (FLOAT phi) {
...
FLOAT UTM::UTMCentralMeridian(int zone) {
  FLOAT cmeridian;
...
FLOAT UTM::FootpointLatitude(FLOAT y) {
...
void UTM::MapLatLonToXY (FLOAT phi, FLOAT lambda, FLOAT lambda0, FLOAT &x, FLOAT &y) {
...
void UTM::MapXYToLatLon (FLOAT x, FLOAT y, FLOAT lambda0, FLOAT& phi, FLOAT& lambda)
{
...
int UTM::LatLonToUTMXY (FLOAT lat, FLOAT lon, int zone, FLOAT& x, FLOAT& y) {
...
// Returns:
// The function does not return a value.
void UTM::UTMXYToLatLon (FLOAT x, FLOAT y, int zone, bool southhemi, FLOAT& lat, FLOAT& lon) {
  FLOAT cmeridian;
